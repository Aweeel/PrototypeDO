...
<body class="bg-gray-50 dark:bg-slate-900 text-gray-900 dark:text-gray-100 transition-colors duration-300">
    ...
    <div class="flex h-screen">
        <aside class="w-64 bg-[#1E2B3B] dark:bg-[#030712] text-white flex flex-col transition-colors duration-300">
            <!-- Logo -->
            <div class="justify-center p-4 flex items-center space-x-3">
                <img src="assets\STI-logo.png" alt="STI Logo" />
            </div>

            <!-- Department Badge -->
            <div class="px-4 py-2 justify-center flex items-center space-x-2 mx-4mb-4">
                <span class="text-blue-900 font-bold text-xl bg-yellow-400 p-2 rounded">DO</span>
                <span class="text-white text-xl px-2 py-1">Discipline Office</span>
            </div>
          ...
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets/Dashboard-icon.png" alt="Dashboard icon" class="w-5 h-5" />
                    <span class="px-3">Dashboard</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets/Cases-icon.png" alt="Cases icon" />
                    <span class="px-3">Cases</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Statistics-icon.png" alt="Statistics icon" />
                    <span class="px-3">Statistics</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Lost-and-Found-icon.png" alt="Lost & Found icon" />
                    <span class="px-3">Lost & Found</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Student-history-icon.png" alt="Student History icon" />
                    <span class="px-3">Student History</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Reports-icon.png" alt="Reports icon" />
                    <span class="px-3">Reports</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
          ...
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Student-handbook-icon.png" alt="Student Handbook icon" />
                    <span class="px-3">Student Handbook</span>
                </a>
                <a href="#" class="flex items-center px-3 py-2 rounded-lg text-gray-300 
          hover:bg-[#33475F] dark:hover:bg-slate-700 
          transition-all duration-150 active:scale-95 hover:shadow-sm">
                    <img src="assets\Audit-log-icon.png" alt="Audit Log icon" />
                    <span class="px-3">Audit Log</span>
                </a>
            </nav>
           ...
           transition-all duration-200 active:scale-95 hover:shadow-sm">
                    <img src="assets/Log-Out-icon.png" alt="Logout icon" class="w-5 h-5" />
                    <span>Log Out</span>
                </button>
            </div>
        </aside>
        ...
        <div class="flex-1 overflow-y-auto">
            <!-- Header -->
            <header class="bg-white dark:bg-slate-800 border-b border-gray-200 dark:border-slate-700 px-8 py-4">
                <div class="flex items-center justify-between">
                    ...
                    <div class=" flex items-center space-x-3">
                        <button onclick="toggleDarkMode()" id="theme-toggle"
                            class="p-1 hover:bg-gray-100 dark:hover:bg-slate-700 rounded-full transition transform hover:scale-105">
                            <img id="theme-toggle-light-icon" src="assets/dark-mode-icon.png" alt="Light Mode Icon"
                                class="w-7 h-7 dark:hidden">
                            <img id="theme-toggle-dark-icon" src="assets/light-mode-icon.png" alt="Dark Mode Icon"
                                class="w-7 h-7 hidden dark:inline">
                        </button>
                        <button class="p-2 rounded-full transition-all duration-200 
           hover:bg-gray-200 dark:hover:bg-slate-700 
           active:scale-95">
                            <img src="assets/notification-dark-icon.png" alt="Notification icon"
                                class="w-6 h-6 dark:hidden">
                            <img src="assets/notification-light-icon.png" alt="Notification icon dark"
                                class="w-6 h-6 hidden dark:inline">
                        </button>
                        </button>
                        <div class="flex items-center space-x-2">
                            <span class="text-m text-gray-600 dark:text-gray-400">John Doe</span>
            ...
            <main class="p-8">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    <!-- Active Cases -->
                    <div
                        class="bg-white dark:bg-slate-800 p-6 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700">
                        <div class="flex items-start justify-between">
                            <div>
                                <p class="text-sm text-gray-600 dark:text-gray-400 mb-1">Active Cases</p>
                                <p class="text-3xl font-bold text-gray-800 dark:text-gray-100" id="activeCases">24</p>
                            </div>
                            <div class="bg-blue-100 dark:bg-[#1E3A8A] p-5 rounded-full transition-colors duration-300">
                                <img src="assets\active-icon.png" alt="Active icon" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 dark:text-gray-100" id="pendingReview">8</p>
                            </div>
                            <div
                                class="bg-yellow-100 dark:bg-[#713F12] p-5 rounded-full transition-colors duration-300">
                                <img src="assets\pending-icon.png" alt="Pending icon" />
                            </div>
                        </div>
                    </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 dark:text-gray-100" id="urgentCases">3</p>
                            </div>
                    ...
                    <div
                        ...
                        <div class="flex items-start justify-between">
                            <div>
                                ...
                                <p class="text-3xl font-bold text-gray-800 dark:text-gray-100" id="unresolvedItems">128
                                </p>
                            </div>
                            <div class="bg-gray-300 dark:bg-[#6B7280] p-5 rounded-full transition-colors duration-300">
                                <img src="assets\unclaimed-icon.png" alt="Unclaimed icon" />
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="grid grid-cols-1 lg:grid-cols-3 gap-6 mb-8">
                    <!-- Recent Cases -->
                    <div
                        class="lg:col-span-2 bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-[#E5E7EB] dark:border-slate-700 p-6 transition-colors duration-300">
          ...
          font-medium transition-all duration-200 active:scale-95">
                    ...
                    <!-- Case Types -->
                    <div
                        class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6 transition-colors duration-300">
                        <div class="flex items-center justify-between mb-3">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
                    ...
                    <div
                        class="bg-white dark:bg-slate-800 rounded-lg shadow-sm border border-gray-200 dark:border-slate-700 p-6 transition-colors duration-300">
                        <div class="flex items-center justify-between mb-3">
                            <h2 class="text-lg font-semibold text-gray-800 dark:text-gray-100 mb-1">Lost & Found Items
                            </h2>
                            <a href="#" class="text-sm text-blue-600 hover:text-blue-800 dark:text-blue-400 dark:hover:text-blue-300 
          font-medium transition-all duration-200 active:scale-95">
                                View All
