...
<div class="flex flex-col items-center gap-4 mb-6">
    ...
    <div class="flex items-center gap-2 bg-slate-700 text-white px-5 py-2 rounded-lg text-sm">
       ...
       <div class="w-1/2 bg-white flex items-center justify-center p-12">
        ...
        <form onsubmit="event.preventDefault(); window.location.href='DODashboard.php';">
    <!-- Email Address -->
    <div class="mb-6">
        <label class="block text-gray-700 text-sm font-medium mb-2">Email Address</label>
        <input type="email" placeholder="name@sti.edu.ph" required
    ...
    <div class="mb-4">
        <div class="flex justify-between items-center mb-2">
            ...
            <a href="Email_forgetpass.php" class="text-blue-500 text-sm hover:underline">Forgot password?</a>
        </div>
    ...
    <p class="text-center text-sm text-gray-600">
        Don't have an account? <a href="#" class="text-blue-500 hover:underline">Contact administrator</a>
    </p>
</form>
