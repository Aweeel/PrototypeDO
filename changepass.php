            ...
            <div class="w-full max-w-md">
                ...
                <form>
                    ...
                    <div class="mb-4">
                        ...
                        <p class="text-gray-500 mb-8 text-xs">Password must be at least 8 characters long with numbers and special characters.</p>
                    </div>
                    ...
                    <!-- Sign In Button -->
                    <button type="button" onclick="window.location.href='login.php';" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-lg transition mb-6">
                         Reset Password
                    </button>
                    
                    <!-- Contact administrator -->
                    <p class="text-center text-sm text-gray-600">
                        Having trouble with your account? <a href="#" class="text-blue-500 hover:underline">Contact administrator</a>
                    </p>
                </form>
