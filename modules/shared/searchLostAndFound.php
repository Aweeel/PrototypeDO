...
if ($_SERVER['REQUEST_METHOD'] === 'GET' && !empty($_GET['search'])) {
    ...
    $searchResults = searchLostItems($conn, $searchTerm, $category);
}
?>
...
<head>
    ...
    <title>STI - <?php echo htmlspecialchars($pageTitle); ?></title>
...
<body class="bg-gray-50 dark:bg-[#1F2937] text-gray-900 dark:text-gray-100 transition-colors duration-300 antialiased">
    <!-- Header -->
    <header class="bg-white dark:bg-[#111827] border-b border-gray-200 dark:border-slate-700 shadow-sm">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-4">
            <div class="flex items-center justify-between">
                <div class="flex items-center space-x-4">
                    <img src="/PrototypeDO/assets/images/sti-logo.png" alt="STI Logo" class="h-12 w-12" onerror="this.style.display='none'">
                    <div>
                        <h1 class="text-2xl font-bold text-blue-600 dark:text-blue-400">STI College</h1>
                        <p class="text-sm text-gray-600 dark:text-gray-400">Lost & Found Search</p>
                    </div>
                </div>
                <button onclick="toggleDarkMode()" 
                        class="p-2 rounded-lg bg-gray-200 dark:bg-slate-700 hover:bg-gray-300 dark:hover:bg-slate-600 transition">
    ...
    <main class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <!-- Search Section -->
        <div class="bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg p-8 mb-8">
            ...
            <form method="GET" class="space-y-4">
                ...
                <button type="submit" 
                        class="w-full px-6 py-3 bg-blue-600 text-white text-lg font-semibold rounded-lg hover:bg-blue-700 dark:hover:bg-blue-500 transition shadow-lg transform hover:-translate-y-0.5">
        ...
        <!-- Search Results -->
        <?php if ($hasSearched): ?>
            <div class="bg-white dark:bg-[#111827] border border-gray-200 dark:border-slate-700 rounded-lg shadow-lg p-8">
    ...
    <!-- Footer -->
    <footer class="bg-white dark:bg-[#111827] border-t border-gray-200 dark:border-slate-700 mt-12">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            <div class="text-center text-gray-600 dark:text-gray-400">
                <p class="mb-2">
                    <i class="fas fa-phone mr-2"></i>Discipline Office: (02) 1234-5678
                </p>
                <p class="mb-4">
                    <i class="fas fa-envelope mr-2"></i>Email: discipline@sti.edu
                </p>
                <p class="text-sm">
                    © <?php echo date('Y'); ?> STI College. All rights reserved.
                </p>
            </div>
        </div>
    </footer>
