        ...
        <div class="flex-1 overflow-y-auto ml-0 md:ml-64 transition-all duration-300"> 
            ...
            <main class="p-4 pt-20 md:p-8 md:pt-28 min-h-screen transition-colors duration-300"> 
                ...
                <div class="bg-white dark:bg-[#111827] rounded-lg shadow-sm border border-gray-200 dark:border-slate-700"> 
                    <form id="reportForm" class="p-4 md:p-6 space-y-4 md:space-y-6"> 
                        ...
                        <div> 
                            ...
                            <div id="uploadDropZone"  
                                ...
                                <div class="text-center"> 
                                    <svg class="mx-auto h-8 w-8 md:h-12 md:w-12 text-gray-400 dark:text-gray-500 mb-2" stroke="currentColor" fill="none" viewBox="0 0 48 48"> 
                            ...
                            <div id="imagePreviewContainer" class="mt-4 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-4 hidden"> 
                                <!-- Previews will be added here --> 
                            </div> 
                        </div> 

                        <!-- Action Buttons --> 
                        <div class="flex flex-col-reverse sm:flex-row justify-end gap-3 pt-4 border-t border-gray-200 dark:border-slate-700"> 
                            <button type="button"  
                                    onclick="window.history.back()" 
                                    class="w-full sm:w-auto px-4 py-2 border border-gray-300 dark:border-slate-600 rounded-lg hover:bg-gray-50 dark:hover:bg-slate-700 transition-colors text-center"> 
                                Cancel 
                            </button> 
                            <button type="submit" 
                                    class="w-full sm:w-auto px-6 py-2 bg-green-600 text-white rounded-lg hover:bg-green-700 transition-colors font-medium text-center"> 
