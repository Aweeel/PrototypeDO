...
<div class="w-1/2 relative flex flex-col items-center justify-center p-12 overflow-hidden bg-slate-800">
    ...
    <!-- Background Image -->
    <div class="absolute inset-0 z-0" style="background-image: url('Container.png'); background-size: cover; background-position: center;"></div>

    <div class="mb-8 relative z-10">
                <div>
                    <img src="stilogo.png" alt="STI Logo" class="w-50 h-auto">
                </div>
            </div>
    ...
    <div class="relative z-10 text-center">
        ...
        <p class="text-gray-300 max-w-md mb-12">
            Create your account to access our comprehensive education management platform and connect with the STI community.
        </p>
    ...
    <div class="flex items-center gap-2 bg-slate-700 text-white px-5 py-2 rounded-lg text-sm">
       ...
       <div class="w-1/2 bg-white flex items-center justify-center p-12">
            <div class="w-full max-w-md">
                ...
                <p class="text-gray-500 mb-8">Please provide the email address associated with your account to reset your password.</p>

                <form>
                    <!-- Email Address -->
                    <div class="mb-6">
                        <label class="block text-gray-700 text-sm font-medium mb-2">Email Address</label>
                        <input type="email" placeholder="name@sti.edu.ph" class="w-full px-4 py-3 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500" required>
                    </div>
                    
                    <button type="submit" onclick="window.location.href='changepass.php';" class="w-full bg-blue-600 hover:bg-blue-700 text-white font-medium py-3 rounded-lg transition mb-6">
                         Reset Password
                    </button>
                    ...
                    <p class="text-center text-sm text-gray-600">
                        Having a problem with your account? <a href="#" class="text-blue-500 hover:underline">Contact administrator</a>
                    </p>
                </form>
                ...
                <div class="mt-6 p-4 bg-blue-50 rounded-lg flex items-start gap-3">
                    ...
                    <div>
                        ...
                        <p class="text-xs text-gray-600">If you're having trouble accessing your account, please contact the IT Helpdesk at <span class="text-blue-600">support@sti.edu</span> or call <span class="text-blue-600">1-800-STI-HELP</span></p>
                    </div>
                </div>
            </div>
        </div>
